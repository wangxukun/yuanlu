...
export function CommentForm({
  ...
  if (!session) {
    return (
      <div className="p-8 md:p-10 bg-ink-50 dark:bg-ink-900 rounded-2xl border border-dashed border-[#D5EDE1] dark:border-ink-800 text-center">
        <div className="max-w-md mx-auto flex flex-col items-center gap-3">
          <div className="w-10 h-10 bg-ink-100 dark:bg-ink-800 rounded-full flex items-center justify-center text-ink-400">
    ...
    >
      ...
      <div className="flex-1 relative">
        ...
        <div className="absolute bottom-3 right-3 flex items-center gap-3">
          <span
            className={clsx(
              "text-xs transition-opacity font-mono text-ink-400",
