        ...
        <div className="bg-gradient-to-r from-primary-500/5 to-accent-500/5 rounded-2xl p-6 border border-primary-500/10 text-center space-y-4 relative">
          ...
          <div className="pt-2 flex flex-col sm:flex-row gap-3">
            <button
              ...
              className="flex-1 btn bg-primary-600 hover:bg-primary-700 border-none text-white h-11 min-h-[44px] rounded-xl text-xs font-bold shadow-lg shadow-primary-600/20 dark:shadow-primary-400/20 hover:scale-[1.02] active:scale-[0.98] transition-all"
            >
              去看看赞助方案
            </button>
            <button
